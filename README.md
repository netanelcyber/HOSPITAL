...
- [**דוח סיכום — engagement report**](docs/engagement-report.md) — סיכום מקיף של המחקר:
  היקף, מתודולוגיה, ממצאים (כולל ממצא ה-memory-safety המאומת, ברמה גבוהה), סטטוס disclosure,
  ורלוונטיות לישראל. נקודת הכניסה המומלצת.
