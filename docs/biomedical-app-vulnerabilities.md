...
מהצלבת כל ה-CVE-ים לעיל עולים חמישה אנטי-פטרנים. רובם הופיעו ב-3+ מוצרים שונים; **P3 הוא חריג — הודגם עד כה רק ב-OpenEMR (במספר endpoint-ים), לא במספר מוצרים** (ראו `suspected-cve-candidates.md` §"איך נגזרה הרשימה"). מוצר שמפגין דפוס באזור אחד — סביר שמפגין אותו גם במקומות שטרם נבדקו:
